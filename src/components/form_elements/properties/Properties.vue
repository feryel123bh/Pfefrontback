<template>
  <div class="el-tabs__inner">
    <el-form v-if="activeField" :model="fieldProperties" :rules="rules" :label-position="labelPosition" ref="fieldProperties">
      <el-row v-if="activeField">
        <el-col :span="12">
          <el-form-item label="Label Name" v-if="activeField.hasOwnProperty('label')">
            <el-input v-model="activeField.label">{{activeField.label}}</el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="Label Width - px" v-if="activeField.hasOwnProperty('label')">
            <el-input-number v-model="activeField.labelWidth" :min="30" :max="1000" controls-position="right"></el-input-number>
          </el-form-item>
        </el-col>
      </el-row>

      <el-form-item label="Height - px" v-if="activeField && activeField.fieldType === 'Carousel'">
        <el-input-number v-model="activeField.controlHeight" controls-position="right"></el-input-number>
      </el-form-item>

      <el-form-item label="Placeholder" v-if="activeField && activeField.isPlaceholderVisible">
        <el-row>
          <el-col :span="5">
            <el-switch v-model="activeField.isPlaceholderVisible"></el-switch>
          </el-col>
          <el-col :span="19">
            <el-input v-if="activeField.isPlaceholderVisible" v-model="activeField.placeholder">
      ...
      <el-row v-if="activeField">
        <el-col :span="12">
          <el-form-item label="Required field?" v-if="activeField.hasOwnProperty('isRequired')">
            <el-switch v-model="activeField.isRequired"></el-switch>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="Layout - Max value is 24" v-if="activeField.hasOwnProperty('span')">
            <el-input-number v-model="activeField.span" :min="1" :max="24" controls-position="right"></el-input-number>
          </el-form-item>
        </el-col>
      </el-row>

      <el-form-item label="Button text" v-if="activeField && activeField.hasOwnProperty('buttonText')">
        <el-input v-model="activeField.buttonText">
          {{activeField.buttonText}}
        </el-input>
      </el-form-item>

      <el-form-item label="Code view" v-if="activeField && activeField.hasOwnProperty('fieldText')">
      ...
      <el-row v-if="activeField">
        <el-col :span="12">
          <el-form-item label="Active Text" v-if="activeField.hasOwnProperty('activeText')">
            <el-input v-model="activeField.activeText">{{activeField.activeText}}</el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="Inactive Text" v-if="activeField.hasOwnProperty('inActiveText')">
            <el-input v-model="activeField.inActiveText">{{activeField.inActiveText}}</el-input>
          </el-form-item>
        </el-col>
      </el-row>

      <el-form-item label="uploadURL" v-if="activeField && activeField.hasOwnProperty('uploadURL')">
        <el-input v-model="activeField.uploadURL">{{activeField.uploadURL}}</el-input>
      </el-form-item>

      <el-form-item label="Items" v-if="activeField && activeField.hasOwnProperty('items')">
      ...
      <el-form-item label="Options" v-if="activeField && !activeField.isFromUrl && activeField.options">
      ...
      <el-form-item label="Table Columns" v-if="activeField && activeField.fieldType === 'TableComponent'">
        <ul class="properties__optionsul">
          <li class="properties__optionslist">
            <el-row :gutter="5">
              <el-col :span="7">
      ...
      <el-form-item label="Html Content" v-if="activeField && activeField.hasOwnProperty('htmlContent')">
        <el-input :rows="10" type="textarea" v-model="activeField.htmlContent">{{activeField.htmlContent}}</el-input>
      </el-form-item>

      <el-button v-if="activeField && activeField.hasOwnProperty('advancedOptions')" @click="advancedPropsVisible = true" style="width: 100%;" type="success">
        Advanced Options
      </el-button>
      <el-dialog :close-on-click-modal="false" title="Advanced Options" :visible.sync="advancedPropsVisible">
        <el-form ref="OptionsForm" :rules="dialogRules">
          <rating-advanced-props v-if="activeField && activeField.fieldType === 'Rating'"></rating-advanced-props>
          <text-input-advanced-props v-if="activeField && activeField.fieldType === 'TextInput'"></text-input-advanced-props>
          <html-advanced-props v-if="activeField && activeField.fieldType === 'HtmlComponent'
"></html-advanced-props>
          <number-input-advanced-props v-if="activeField && activeField.fieldType === 'NumberInput'"></number-input-advanced-props>
          <select-list-advanced-props v-if="activeField && activeField.fieldType === 'SelectList'"></select-list-advanced-props>
          <options-advanced-props v-if="activeField && (activeField.fieldType === 'RadioButton' || activeField.fieldType === 'Checkbox')"></options-advanced-props>
        </el-form>
...
export default {
  ...
  mounted() {
    if (this.activeField) {
      ...
      if (this.activeField.hasOwnProperty('span')) {
